...
def add_friendship(network, name1, name2):
    ...
    #       already known to be friends, nothing needs to be done.
        ...
        #if name1 and name 2 are already in the network do nothing

        #if name1 and name2 in network:
            #return
...
def print_command(network, namelist):
    ...
    # displays all names in network dict keys_names=keys
    # loop and print the values of key words in the dict
...
def common_friends_command(network, namelist):
    ...
    common_friends = []
    #looping to check the key name in the data structure
    #if there is a name, append that name into the list
