...
def print_command(network, namelist):
    ...
    for key_friend in sorted(network):
        print(key_friend)
        for friends in sorted(network[key_friend]):
            print(f"- {friends}")
...
def common_friends_command(network, namelist):
    ...
    # if a person does not have common friends with him/her
    ...
    if name2 not in namelist:
        print(f"{name2} has no common friends with him/herself.")
        return
    ...
    # if <name1> and <name2> have no common friends
    if len(mutual_friends) == 0:
        print(f"{name1} and {name2} have no common friends.")
        return None

    # print the common friends of <name1> and <name2> in alphabetical order
    for friend_names in sorted(mutual_friends):
        print(friend_names)
